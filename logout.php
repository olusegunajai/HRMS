...
<div class="head grey_box">
  ...
  <form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST">
    ...
    <input class="input" type="text" name="user" value="" placeholder="e.g me@cfao.com">
    <input class="input" type="password" name="pwd"  placeholder="PASSWORD">
        	  <input type="submit" class="btn lemon" value="Login">
    </div>
    </form>
</div>
<div class="lace"></div>
<div class="case">
	<div class="carton">
        ...
        <p class="msg">
       	You have been successfully logged out of CFAO HR Portal.<br> To login again kindly fill in the log in form above or <strong><a href="index.php">click here</a></strong> to go back to the home page. </p>
  </div>
</div>
