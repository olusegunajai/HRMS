...
<?php require_once('publicaccesscheck.php'); ?>
	...
	<div class="carton">
        ...
        <article class="pagejob">
             <table border="0">
	          ...
	          <a href="vacancedetail.php?jobId=<?php echo $row_rsJobs['jobId']; ?>"><strong>View Detais & Apply &rarr;</strong></a></p>
   		    </div>
